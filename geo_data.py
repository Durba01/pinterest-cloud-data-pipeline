...
def post_geo_to_api(geo_result):
    invoke_url = "https://uodinybje6.execute-api.us-east-1.amazonaws.com/dev/topics/0a5afda0229f.geo"  # Replace this with your actual API URL for geo data
